...
SOURCES: List[Source] = [
    ...
    Source(
        ...
        is_active=False,  # 2026-04-25: RSS возвращает 404, ждём новый endpoint от SHRM
        quality_score=0.90,
    ...
    Source(
        ...
        lang="en",
        category="hr_official",
        is_active=False,  # 2026-04-25: 429 rate-limit при опросе, нестабильный доступ
        quality_score=0.85,
    ...
    Source(
        ...
        lang="en",
        category="media",
        is_active=False,  # 2026-04-25: 404 на этом endpoint, требуется поиск нового RSS
        quality_score=0.78,
        added_date="2025-01-15",
    ...
    Source(
        ...
        lang="en",
        category="media",
        is_active=False,  # 2026-04-25: 503 Service Unavailable, RSS похоже отключён
        quality_score=0.70,
        added_date="2024-01-01",
    ...
    Source(
        ...
        url="https://old.reddit.com/r/humanresources/.rss",
        lang="en",
        category="community",
        is_active=True,
        quality_score=0.70,
    ...
    Source(
        ...
        lang="ru",
        category="community",
        is_active=False,  # 2026-04-25: SSL handshake fails, проблема с сертификатом сайта
        quality_score=0.72,
        added_date="2025-04-22",
